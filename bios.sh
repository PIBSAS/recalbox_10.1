#!/bin/bash
###########################################################################
# Repositorio: recalbox-10.1-Bios 2026
...
RUTA="https://raw.githubusercontent.com/PIBSAS/recalbox-10.1/main/"
...
declare -A bios_archivos=(
    ...
    ["SAMMY ATOMISWAVE"]="awbios.zip"
    ["SEGA NAOMI"]="naomi.zip|airlbios.zip|hod2bios.zip"
    ["SEGA NAOMI GD-ROM"]="naomigd.zip"
    ...
    ["SEGA SATURN"]="saturn_bios.bin|sega_101.bin|mpr-17933.bin|mpr-18811-mx.ic1|mpr-19367-mx.ic1"
    ...
    ["SEGA NAOMI 2"]="naomi2.zip"
    ["MICROSOFT XBOX"]="Complex_4627.bin|mcpx_1.0.bin"
    ["SCUMMVM"]="MT32_CONTROL.ROM|MT32_PCM.ROM"
    ["ST-V"]="epr-20091.ic8|epr-17952a.ic8|epr-17954a.ic8|stvbios.zip"
    ["TRIFORCE"]="IPL.bin|segaboot.gcm"
)
cleanup_bios() {
    echo
